...
- Create a `.env` with the scheme found here: .env.schema
...
## Docker
1- Checkout repo
2- Create a .env file and fill it based on .env.schema
3- Run build.sh
4- Run `docker run -it -p 3000:3000 ucsf-portal-ui:latest`